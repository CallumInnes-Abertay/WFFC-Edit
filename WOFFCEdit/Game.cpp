...
void Game::Render()
{
	...
	if (m_grid)
	{
		...
		constexpr XMVECTORF32 xaxis = {512.f, 0.f, 0.f};
	...
	for (int i = 0; i < numRenderObjects; i++)
	{
		...
		m_displayList[i].m_model->Draw(context, *m_states, local, m_camera->GetViewMatix(), m_projection, false);
