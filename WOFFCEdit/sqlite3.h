...
using sqlite_int64 = __int64;
using sqlite_uint64 = unsigned __int64;
#else
...
*/
using sqlite3_file = struct sqlite3_file;
...
** database corruption.
*/
using sqlite3_io_methods = struct sqlite3_io_methods;
...
*/
using sqlite3_vfs = struct sqlite3_vfs;
...
** call to xShutdown().
*/
using sqlite3_mem_methods = struct sqlite3_mem_methods;
...
*/
using sqlite3_value = struct Mem;
...
*/
using sqlite3_context = struct sqlite3_context;
...
*/
using sqlite3_vtab = struct sqlite3_vtab;
using sqlite3_index_info = struct sqlite3_index_info;
using sqlite3_vtab_cursor = struct sqlite3_vtab_cursor;
using sqlite3_module = struct sqlite3_module;
...
*/
using sqlite3_blob = struct sqlite3_blob;
...
** prior to returning.
*/
using sqlite3_mutex_methods = struct sqlite3_mutex_methods;
...
*/
using sqlite3_pcache = struct sqlite3_pcache;
...
** functions.
*/
using sqlite3_pcache_methods = struct sqlite3_pcache_methods;
...
*/
using sqlite3_backup = struct sqlite3_backup;
...
using sqlite3_rtree_geometry = struct sqlite3_rtree_geometry;
